...
//synchronously file ma write karva mate
...
//Asynchronously file ma write karva mate
// fs.writeFile("./write.txt","Hello HERE Tej",(err)=>{console.log(err)});
//aa uper ni line jo write.txt nai hoy to e pehla create karse pachi ema content nakhse Hello Tej
//ane jo aa file hase to ema je content hase e bhusai jase ane eni jagya e Hello Tej aavi jase
//callback function che te file ma succesfully write thai jay pachi execute thase ane jo ema kai error hase to e error batadse
...
//file ne copy karva mate
//matlab read.txt ni copy bani jase copy1.txt
// fs.cpSync("./read.txt", "./copy1.txt");
